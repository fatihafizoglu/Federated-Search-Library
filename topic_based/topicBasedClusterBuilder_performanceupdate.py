...
class Clusters:
	...
	def add_new_document_to_new_word_frequencies(self,document,cluster_id):
		...
		# self.new_word_frequencies[cluster_id].update(document.word_frequencies)
		# self.new_avarage_word_frequencies.update(document.word_frequencies)
		for word,freq in document.get_word_frequencies().items():
			if self.new_word_frequencies[cluster_id].has_key(word):
			...
			if self.new_avarage_word_frequencies.has_key(word):
...
# print clusters.avarage_word_frequencies["total_word_count"]
